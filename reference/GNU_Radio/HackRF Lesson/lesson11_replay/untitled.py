...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_center_freq(447.7e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\qus70\\OneDrive\\Desktop\\GNU_Radio\\HackRF Lesson\\lesson11_replay\\bel', False)
