...
def run_exp05_capture_session(
    ...
    metadata.update(
        {
            "experiment": "exp5_bfsk_bpsk_classification_improvement",
            "purpose": "Improve BFSK/BPSK recall and reduce BFSK/BPSK to BASK confusion",
            "rf_path": "ota_antenna",
    ...
    print(f"Experiment 5 metadata updated: {metadata_path}")
    return session_dir
