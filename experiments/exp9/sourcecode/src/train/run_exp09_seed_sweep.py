...
def run_exp09_seed_sweep(
    ...
    for seed in seeds:
        ...
        train_cmd = [
            sys.executable,
            "-m",
            "src.train.train_exp09_classifier",
            "--config",
            config_path,
            "--preset",
            "train",
        ...
        eval_cmd = [
            sys.executable,
            "-m",
            "src.app.evaluate_exp09_blind_classifier",
            "--checkpoint",
...
def main() -> None:
    ...
    parser.add_argument("--output-root", default="../results/exp09")
    parser.add_argument("--seeds", nargs="+", type=int, default=[42, 43, 44])
    parser.add_argument("--model-type", default="resnet1d")
    parser.add_argument("--eval-split", default="test")
    args = parser.parse_args()
    run_exp09_seed_sweep(args.config, args.data_root, args.output_root, args.seeds, args.model_type, args.eval_split)
